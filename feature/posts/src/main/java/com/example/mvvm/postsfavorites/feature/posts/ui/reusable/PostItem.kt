...
fun PostItem(
    ...
    Card(
        ...
        Row(
            ...
            GlideImage(
                model = "https://i.pravatar.cc/300?u=${post.userId}",
...
private fun PreviewPostItem() {
    AppTheme {
        PostItem(
            post = Post(id = 1, userId = 1, title = "Title", body = "Body content sample with a few words to show wrapping", isFavorite = false),
            onClick = {},
        )
    }
}
